<?php
// este es inventario dos de prueba 2
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($elementos as $key => $elemento) {
        ...
        $sql_inventario = "INSERT INTO inventario (elemento, disponibilidad, cantidad, descripcion, fecha, hora) VALUES ('$elemento', '$disponibilidad', '$cantidad', '$descripcion', '$fecha', '$hora')";

        // Insertar datos en la tabla de historial
        $sql_historial = "INSERT INTO historial (elemento, disponibilidad, cantidad, descripcion, fecha, hora) VALUES ('$elemento', '$disponibilidad', '$cantidad', '$descripcion', '$fecha', '$hora')";

        if ($conexion->query($sql_inventario) === TRUE && $conexion->query($sql_historial) === TRUE) {
            echo "Registro de $elemento guardado con éxito.<br>";
        } else {
            echo "Error en inventario: " . $conexion->error . "<br>";
            echo "Error en historial: " . $conexion->error . "<br>";
        }
    }
}
$conexion->close();
...
<body>
    <div class="contenedor">
        <img src="../img/logosena.png" alt="Logotipo SENA" class="logo">
